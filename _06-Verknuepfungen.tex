...
\chapter{Verknüpfungen} \label{kap:verknuepfungen}


\section{Allgemeines}


\begin{defin} \label{def:verknuepfung} \index{Verknüpfung}
...
\begin{bsp} \index{Symmetrische Gruppe} \index{Permutation} \quad
    %Viele wichtige Gruppen erwachsen als Einheitengruppen aus Monoiden.
    \begin{enumerate}
