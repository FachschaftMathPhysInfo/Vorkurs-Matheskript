...
\begin{defin}[* feinere/gröbere Relation] \label{def:groebererelation} \index{feinere Relation} \index{groebere Relation@gröbere Relation}
...
\begin{aufg}[Eigenschaften von Relationen] \label{aufg:relationen}
