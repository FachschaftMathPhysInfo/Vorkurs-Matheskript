...
\setchapterpreamble[c][.7\textwidth]{\itshape\color{gray}\small
    In diesem Vortrag werden grundlegende Eigenschaften und Operationen von Mengen vorgestellt. Ebenso werden Familien und Tupel eingeführt, da sie grundlegend für die Konzepte „Relation“, „Folge“ und „Verknüpfung“ in den späteren Vorträgen sind.
\vspace{24pt}}
...
\begin{defin}[Menge] \label{def:menge} \index{Menge}
    Eine \textbf{Menge} ist ein mathematisches Objekt, dem andere Objekte als ihre sogenannten \textbf{Elemente} angehören können.% Sie ist allein dadurch bestimmt, welche Elemente sie umfasst.
\end{defin}
...
\begin{defin}[Leere Familie] \label{def:leerefam}
