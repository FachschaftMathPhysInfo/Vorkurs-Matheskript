...
\newacronym{sym:N}{$\N$}{Menge der natürlichen Zahlen (mit oder ohne Null)}
...
\newacronym{sym:inklusion}{$U\hookrightarrow X$}{Inklusion der Teilmenge $U\subseteq X$}
...
\newacronym{sym:teilt}{\quad\\[0.5em] $m\mid n$}{$m$ teilt $n$}
...
\newacronym{sym:projektion}{$X\twoheadrightarrow X/{\sim}$}{Projektion auf die Faktormenge}
