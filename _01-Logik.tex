...
\begin{nota}[Definition per Kennzeichnung] \label{kennzeichnung} \index{Kennzeichnung}
    ...
    %Manchmal werden Definitionen per Kennzeichnung auch schon vorgenommen, wenn es zwar höchstens ein Objekt mit der Eigenschaft $E$ gibt, nicht aber auch mindestens eines.
\end{nota}
...
\begin{bsp}
    ...
    \begin{enumerate}
        ...
        jeweils Tautologien, was mit Wahrheitstafeln überprüft werden kann.% Hier ist eine Wahrheitstafel für die Formel $A\lor \neg A$:
        %\[\begin{tabular}{c|cc}
         %   $A$ & $\neg A$ & $A\lor \neg A$ \\
          %  \hline
           % w&f&w\\
